...
* Search & Filter: Filtering by artist, genre, or release year (TODO).
* Collection Stats: View high-level insights into your collection (Total count, most frequent artists, etc.). (TODO)
